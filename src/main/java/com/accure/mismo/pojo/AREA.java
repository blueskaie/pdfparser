...
public class AREA {
    ...
    @XmlAttribute(name = "InsulationRatingDescription")
    @XmlSchemaType(name = "anySimpleType")
    protected String insulationRatingDescription;
     ...
     *     
     */
    public String getInsulationRatingDescription() {
     ...
     *     
     */
    public void setInsulationRatingDescription(String value) {
